...
Screenshot from the GCP Cloud Build history showing recent builds of our Docker images (including build status and timestamps). ![Cloud Build](figures/cloud_build.JPG)
